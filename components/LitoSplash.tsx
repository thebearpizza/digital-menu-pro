...
// Zona dell'incrocio: i tratti che scendono non devono scoprire la coda che li attraversa.
const CROSSING_ZONE = 'M15.5 31.6L21 31.6L23.2 34.1L24.8 35.2L24.8 38L15.5 38Z'
const PEN_STROKES = [
  { d: 'M31.4 22C32 21.73 33.57 21.18 35 20.4C36.43 19.62 38.5 18.43 40 17.3C41.5 16.17 43.1 14.65 44 13.6C44.9 12.55 45.4 11.73 45.4 11C45.4 10.27 44.73 9.57 44 9.2C43.27 8.83 42.13 8.68 41 8.8', w: 5, len: 23.75, clip: false },
  { d: 'M41 8.8C39.87 8.92 38.43 9.32 37.2 9.9C35.97 10.48 34.67 11.42 33.6 12.3C32.53 13.18 31.63 14.15 30.8 15.2C29.97 16.25 29.28 17.38 28.6 18.6C27.92 19.82 27.4 21.1 26.7 22.5C26 23.9 25.12 25.58 24.4 27C23.68 28.42 23.15 29.82 22.4 31', w: 6.2, len: 30.27, clip: true },
  { d: 'M22.4 31C21.65 32.18 20.8 33.12 19.9 34.1C19 35.08 18.23 36.02 17 36.9', w: 3.9, len: 8.03, clip: false },
  { d: 'M17 36.9C15.77 37.78 13.87 38.87 12.5 39.4C11.13 39.93 9.85 40.12 8.8 40.1C7.75 40.08 6.8 39.75 6.2 39.3C5.6 38.85 5.03 38.02 5.2 37.4', w: 5.2, len: 13.96, clip: true },
  { d: 'M5.2 37.4C5.37 36.78 6.23 36.07 7.2 35.6C8.17 35.13 9.62 34.78 11 34.6C12.38 34.42 14.08 34.4 15.5 34.5C16.92 34.6 18.08 34.85 19.5 35.2', w: 5.2, len: 15.27, clip: false },
  { d: 'M19.5 35.2C20.92 35.55 22.42 36.03 24 36.6C25.58 37.17 27.33 38 29 38.6C30.67 39.2 32.42 39.9 34 40.2C35.58 40.5 37.12 40.63 38.5 40.4C39.88 40.17 41.28 39.5 42.3 38.8C43.32 38.1 44.22 36.63 44.6 36.2', w: 4.4, len: 27.52, clip: false },
]
          ...
          <div className="ls-leaf ls-grain">
            <svg className="ls-logo" viewBox="0 0 50 50" aria-hidden="true">
              <defs>
                ...
                <clipPath id="ls-cross" clipPathUnits="userSpaceOnUse">
                  <path clipRule="evenodd" d={`M-5 -5H55V55H-5Z ${CROSSING_ZONE}`} />
                </clipPath>
                  ...
                  {PEN_STROKES.map((st, i) => {
                    ...
                    return (
                      <path
                        ...
                        d={st.d}
                        strokeWidth={st.w}
                        clipPath={st.clip ? 'url(#ls-cross)' : undefined}
                        style={{
