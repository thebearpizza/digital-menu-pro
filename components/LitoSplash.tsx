...
const PEN_STROKES = [
  ...
  { d: 'M41 8.8C39.87 8.92 38.43 9.32 37.2 9.9C35.97 10.48 34.67 11.42 33.6 12.3C32.53 13.18 31.63 14.15 30.8 15.2C29.97 16.25 29.28 17.38 28.6 18.6C27.92 19.82 27.4 21.1 26.7 22.5C26 23.9 25.2 25.58 24.4 27C23.6 28.42 22.77 29.8 21.9 31', w: 6.2, len: 30.52 },
  { d: 'M21.9 31C21.03 32.2 20.15 33.2 19.2 34.2C18.25 35.2 17.32 36.13 16.2 37', w: 3.4, len: 8.3 },
  { d: 'M16.2 37C15.08 37.87 13.73 38.88 12.5 39.4C11.27 39.92 9.85 40.12 8.8 40.1C7.75 40.08 6.8 39.75 6.2 39.3C5.6 38.85 5.03 38.02 5.2 37.4C5.37 36.78 6.23 36.07 7.2 35.6C8.17 35.13 9.62 34.78 11 34.6C12.38 34.42 14.08 34.4 15.5 34.5C16.92 34.6 18.08 34.85 19.5 35.2', w: 5.2, len: 28.5 },
