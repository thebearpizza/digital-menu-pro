  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Colonna sinistra: impostazioni menu */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button type="button" onClick={handleDelete}
                className="border border-red-200 text-red-500 px-6 py-2.5 rounded-xl text-sm font-medium hover:bg-red-50 transition-colors">
                Elimina menu
              </button>
            </div>
        ...
        {/* Colonna destra: piatti (placeholder) */}
